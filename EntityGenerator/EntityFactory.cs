...
namespace EntityGenerator
{
    public class EntityFactory
    {
        ...
        /// <returns></returns>
        public Type CreateDynamicType<T>(Entity entity) where T : BaseEntity
        {
        ...
        /// <param name="properties"></param>
        /// <returns></returns>
        public TypeBuilder CreateDynamicTypeBuilder<T>(Entity entity)
            where T : BaseEntity
        {
        ...
        public void CreateProperties(TypeBuilder typeBuilder, ICollection<MetadataModel.Attribute> properties)
        {
            properties.ToList().ForEach(p => CreateFieldForType(p));
        }

        private void CreateFieldForType(MetadataModel.Attribute attribute)
        {
